...
$query=mysqli_query($con,"insert into tbl_medicine(mno,mname,mcategory,description,price,stock)values('$msno','$mname','$category','$mdesc','$price','$stock')");
...
<!--nav-->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Add Medicine
						 </div>
  ...
  <input class="form-control" name="msno" id="cshort" required="required"  onblur="courseAvailability()">       
	 ...
	 <br><br>				
		...
		<div class="col-lg-6">
		<input class="form-control" name="stock" id="cshort" required="required">       
		<span id="course-availability-status" style="font-size:12px;"></span>				
		</div>
		</div>	
